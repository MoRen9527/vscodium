...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  PRODUCT_NAME="TriCade"
  PRODUCT_CODE="TriCade"
...
# TriMetaverse: BINARY_DIR overridden to local C:\Temp\tricade-src for build.
BINARY_DIR="C:\\Temp\\tricade-src"
# Original: "..\\..\\..\\VSCode-win32-${VSCODE_ARCH}"
LICENSE_DIR="..\\..\\..\\vscode"
